...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Paleta principal inspirada en Linear/Vercel
        primary: {
          50: '#EEF2FF',
          100: '#E0E7FF',
          200: '#C7D2FE',
      ...
      backgroundImage: {
        // Gradientes tipo Vercel/Linear
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-hero': 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
        'gradient-hero-dark': 'linear-gradient(135deg, #1e1b4b 0%, #312e81 50%, #4c1d95 100%)',
